...
public class Main {
    ...
    public static void main(String[] args) {
        String text = "Добрый вечер! Всего за сегодня было отработано 8.5 ч. Задачи, выполненные за сегодня: 1. 888 Holdings - Poker - 6,5 ч. Task 1190615:[QA Mobile] Exploratory Testing 7.14 - Sit&Go - 3.5 ч. Gameplay HH Ad-";
